...
import com.github.CCweixiao.HBaseTableOperations;
...
@Component
public class HBaseKerberosTemplate extends AbstractHBaseKerberosTemplate implements HBaseTableOperations {

    public HBaseKerberosTemplate() {super();}

    public HBaseKerberosTemplate(Configuration configuration) {
        super(configuration);
    }

    public HBaseKerberosTemplate(String zkHost, String zkPort) {
        super(zkHost, zkPort);
    }

    public HBaseKerberosTemplate(Properties properties) {
        super(properties);
    }
