 ...
 */
public abstract class AbstractHBaseKerberosTemplate extends AbstractHBaseKerberosConfig {

    public AbstractHBaseKerberosTemplate() {
        super();
    }

    public AbstractHBaseKerberosTemplate(Configuration configuration) {
        super(configuration);
    }

    public AbstractHBaseKerberosTemplate(String zkHost, String zkPort) {
        super(zkHost, zkPort);
    }

    public AbstractHBaseKerberosTemplate(Properties properties) {
        super(properties);
    }
